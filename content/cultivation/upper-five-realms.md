...
sourceNotes: >
  The division of cultivation into lower and "Upper Five Realms" (上五境) is established
  throughout the series, including references in the discussion of Natal Porcelain and
  high-realm cultivators such as Sword Immortals and Heavenly Lords. Precise volume/chapter
  citations and the exact names of each constituent realm have not yet been fully pinned in
  this database, so the entry remains to-be-verified pending exact source confirmation.
firstAppearance: ""
...
- The exact names and ordering of the individual realms within the Upper Five Realms are intentionally left unstated here, pending source confirmation, to avoid introducing unsupported detail.

## References

- Source references needed: This entry summarizes a broadly established cultivation concept and has not yet been pinned to specific volume/chapter citations. Status remains to-be-verified pending exact source confirmation.
