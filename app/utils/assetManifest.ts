...
const manifest: AssetManifest = {
  ...
  assets: [
    ...
    },
    {
      ...
      sectionFit: ['timeline'],
      mood: 'elegiac',
      subject: 'Timeline section hero banner — PLANNED, FILE DOES NOT EXIST',
      aspectRatio: '16:9',
      cropType: 'center',
      recommendedUse: 'Source or commission an official Timeline section hero atmosphere and add as a new hero-atmosphere entry.',
      avoidUse: 'Anything. File is not on disk.',
      priority: 'p1',
      curatedAt: '2026-06-20',
      curatedBy: 'design-engine-35b',
      notes: 'INTEGRITY FIX (35B-1): /images/banners/timeline-banner.webp does not exist on disk. Downgraded to role: unusable. Timeline section currently uses /images/timeline/chen-pingan-black-gold-timeline.webp via TimelineCinematicHero component (manifest entry asset.timeline-chen-pingan-black-gold). Source an official Timeline banner in Stage 35B-2 to replace this slot.',
    },
    {
    ...
    // ─── Live-used Purchased Ink Assets (Stage 35B-2B) ────────────────────────

    {
      id: 'asset.ink-divider-rough-01',
      filePath: '/images/ui/purchased/ink/ink-divider-rough-01.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'martial',
      subject: 'Rough ink divider — heavy brush stroke for sword manual section breaks',
      aspectRatio: '16:5',
      cropType: 'full-bleed',
      recommendedUse: 'Section divider between major parts of a swordsmanship detail page. Used in SwordDaoManualHero and swordsmanship index.',
      avoidUse: 'Outside Swordsmanship. As a background wash.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Live-used: SwordDaoManualHero.vue (3 refs), swordsmanship/index.vue.',
    },
    {
      id: 'asset.ink-divider-rough-02',
      filePath: '/images/ui/purchased/ink/ink-divider-rough-02.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'martial',
      subject: 'Rough ink divider — medium brush stroke variant for sword manual section breaks',
      aspectRatio: '16:5',
      cropType: 'full-bleed',
      recommendedUse: 'Section divider for Swordsmanship. Alternate variant to ink-divider-rough-01.',
      avoidUse: 'Outside Swordsmanship.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Live-used: SwordDaoManualHero.vue (3 refs).',
    },
    {
      id: 'asset.ink-divider-rough-03',
      filePath: '/images/ui/purchased/ink/ink-divider-rough-03.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'martial',
      subject: 'Rough ink divider — third variant, candidate for sword manual sections',
      aspectRatio: '16:5',
      cropType: 'full-bleed',
      recommendedUse: 'Section divider for Swordsmanship. Third variant for variety.',
      avoidUse: 'Outside Swordsmanship.',
      priority: 'p2',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Candidate — not currently referenced in live code. Add to SwordDaoManualHero or swordsmanship pages when appropriate.',
    },
    {
      id: 'asset.ink-title-stroke-long-06',
      filePath: '/images/ui/purchased/ink/ink-title-stroke-long-06.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'martial',
      subject: 'Long ink title stroke — heavy brush title underline for sword manual headings',
      aspectRatio: '16:3',
      cropType: 'center',
      recommendedUse: 'Title underline / section heading accent for Swordsmanship detail pages. Registered in main.css as --jl-title-brush.',
      avoidUse: 'As a card background.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Live-used: main.css (--jl-title-brush variable), SwordDaoManualHero.vue.',
    },
    {
      id: 'asset.ink-wash-cloud-soft-03',
      filePath: '/images/ui/purchased/ink/ink-wash-cloud-soft-03.webp',
      role: 'background-wash',
      sectionFit: ['swordsmanship'],
      mood: 'misty',
      subject: 'Soft cloud ink wash — pale atmospheric cloud form for sword manual atmosphere',
      aspectRatio: '16:9',
      cropType: 'full-bleed',
      recommendedUse: 'Background atmosphere layer on SwordDaoManualHero. Opacity 0.04–0.10.',
      avoidUse: 'As a card hero image.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Live-used: SwordDaoManualHero.vue.',
    },
    {
      id: 'asset.ink-corner-stain-04',
      filePath: '/images/ui/purchased/ink/ink-corner-stain-04.webp',
      role: 'hover-ornament',
      sectionFit: ['swordsmanship'],
      mood: 'martial',
      subject: 'Ink corner stain — dark concentrated mark for sword manual corner placement',
      aspectRatio: '1:1',
      cropType: 'lower-third',
      recommendedUse: 'Corner ornament on SwordDaoManualHero. Opacity 0→0.85 on hover or static at low opacity.',
      avoidUse: 'As a primary image.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Live-used: SwordDaoManualHero.vue (background: center/contain).',
    },
    {
      id: 'asset.ink-mountain-smear-01',
      filePath: '/images/ui/purchased/ink/ink-mountain-smear-01.webp',
      role: 'background-wash',
      sectionFit: ['swordsmanship'],
      mood: 'pastoral',
      subject: 'Mountain ink smear — mountain ridge impression on parchment',
      aspectRatio: '16:9',
      cropType: 'full-bleed',
      recommendedUse: 'Background wash for SwordDaoManualHero atmosphere layer. Opacity 0.04–0.10.',
      avoidUse: 'As a card thumbnail.',
      priority: 'p1',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
    ...
    {
      id: 'asset.ink-divider-thin-02',
      filePath: '/images/ui/purchased/ink/ink-divider-thin-02.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'elegiac',
      subject: 'Thin ink divider — hairline horizontal stroke, second variant',
      aspectRatio: '16:1',
      cropType: 'full-bleed',
      recommendedUse: 'Between subsections in Swordsmanship ledger layouts.',
      avoidUse: 'As a hero or hover ornament.',
      priority: 'p2',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'Candidate — not currently referenced in live code. Add when thin ink dividers are needed.',
    },
    {
      id: 'asset.ink-divider-thin-03',
      filePath: '/images/ui/purchased/ink/ink-divider-thin-03.webp',
      role: 'section-divider',
      sectionFit: ['swordsmanship'],
      mood: 'elegiac',
      subject: 'Thin ink divider — hairline horizontal stroke, third variant',
      aspectRatio: '16:1',
      cropType: 'full-bleed',
      recommendedUse: 'Between subsections in Swordsmanship ledger layouts.',
      avoidUse: 'As a hero or hover ornament.',
    ...
    // ─── Alternate-format Portrait Entries (Stage 35B-2B) ────────────────────

    {
      id: 'asset.char-ning-yao-portrait-jpg',
      filePath: '/images/characters/ning-yao.jpg',
      role: 'dossier-portrait',
      sectionFit: ['characters'],
      mood: 'misty',
      subject: 'Portrait of Ning Yao — JPG alternate format',
      aspectRatio: '3:4',
      cropType: 'eyes-up',
      recommendedUse: 'Fallback portrait format for Ning Yao if webp is unavailable. Prefer webp.',
      avoidUse: 'As a card thumbnail.',
      priority: 'p3',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'ALTERNATE FORMAT — same provenance status as ning-yao.webp (PROVISIONAL). webp version is preferred. app/pages/index.vue uses this JPG variant.',
    },
    {
      id: 'asset.char-qi-jingchun-portrait-jpg',
      filePath: '/images/characters/qi-jingchun.jpg',
      role: 'dossier-portrait',
      sectionFit: ['characters'],
      mood: 'solemn',
      subject: 'Portrait of Qi Jingchun — JPG alternate format',
      aspectRatio: '3:4',
      cropType: 'eyes-up',
      recommendedUse: 'Fallback portrait format for Qi Jingchun if webp is unavailable. Prefer webp.',
      avoidUse: 'As a card thumbnail.',
      priority: 'p3',
      curatedAt: '2026-06-21',
      curatedBy: 'design-engine-35b-2b',
      notes: 'ALTERNATE FORMAT — same provenance status as qi-jingchun.webp (PROVISIONAL). webp version is preferred. app/pages/index.vue uses this JPG variant.',
    },
