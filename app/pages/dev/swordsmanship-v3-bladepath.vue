...
// Dev-route: Swordsmanship V3 — Blade Path Descent prototype
if (!import.meta.dev) {
...
useSeoMeta({
  title: 'Sword Dao Manual — Blade Path | Jian Lai Wiki',
  description: 'Blade Path Descent — a vertical descent through the sword blade. Caged Sparrow technique core, marginal commentary, recorded arts, and related archives.',
})
</script>
